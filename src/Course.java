public class Course {
    /**
     * 3. ƒобавить класс Course (полоса преп€тствий), в котором будут находитьс€:
     * массив преп€тствий, метод который будет просить команду пройти всю полосу;
     */
    Let[] let = new Let[3];
    ...
    //¬ывод информации о полосе преп€тствий
